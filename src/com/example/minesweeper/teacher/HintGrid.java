...
public class HintGrid extends Grid {
	...
	/**
	 * Checks location if any hint can be performed.
	 * Adds hint to queue if found. 
	 * @param queue Queue to add hint to
	 * @param r row of tile to check
	 * @param c column of tile to check
	 ...
	 * @return hint text
	 */
	public String revealAlgorithm(
			LinkedList<TileAction> hintQueue,
			int r, int c) {
	...
	/**
	 * Check if the number of adjacent mines equals the number of uncovered tiles
	 * @param hintQueue queue to populate with hint tiles
	 * @param r row of tile
	 * @param c column of tile
	 * @return hint text
	...
	/**
	 * Check if all your tiles are shared by a neighbor.
	 * If the neighbor has more surrounding mines and the difference is equal to the number of not shared tiles,
	 * flag those tiles.
	 * Otherwise, if the neighbor has the same amount of surrounding mines,
	 * click the tiles not shared
	 * @param hintQueue queue to populate with hint tiles
	 * @param r row of tile
	 * @param c column of tile
	 * @return hint text
	...
	/**
	 * Split list of tiles into tiles that are shared by both lists, and those that are not.
	 * @param a1 list to split
	 * @param a2 list to compare against
