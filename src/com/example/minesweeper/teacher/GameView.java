...
public class GameView extends SurfaceView implements SurfaceHolder.Callback {
	 ...
	 * @param parent Parent of view for accessing other UI elements. 
	 */
	...
	/**
	 * Clicks grid at location.
	 * If mine is clicked, stop game.
	 * Update counter.
	 * @param r row of tile
	...
	/**
	 * If hints are queued, process them.
	 * Otherwise, try to queue hints.
	 * If no hints are found, indicate to caller that you should guess.
	 * @return null if game is not active or hints are queued,
	 * Game.GUESS if hint could not be found,
	 * hint tooltip text
	 */
	public String hint() {
	...
	/**
	 * Processes hint queue and performs the corresponding action at the stored coordinates. 
	...
	/** Locate unrevealed tiles and randomly add one to click into the hint queue. */
	public void guess() {
		// Start time during the first touch
		if (!gameTimer.isOn()) {
			gameTimer.startTimer();
	...
	/**
	 * Update text views displays of counts of non-mine and mine tiles.
	 * Ends game and displays victory message if non-mile tiles reaches 0. 
	 */
	 ...
	 * @param r rows to move over
	 * @param c columns to move over
	 */
	 ...
	 * @param r row to scroll to
	 * @param c column to scroll to
	 */
	...
	public Bitmap getBitmap(Tile tile) {
		...
		if (tile.isExploded()) {
			...
			switch (tile.getMines()) {
				case -1: id = R.drawable.mine; break;
    			...
    			default: id = R.drawable.miner; break;
			}
